...
- Name: product_management.spec.js >> product management >> add non-existing product(negative test)
- Location: tests\product_management.spec.js:35:9

# Error details

```
Error: Product "iPhone" not found.
```
